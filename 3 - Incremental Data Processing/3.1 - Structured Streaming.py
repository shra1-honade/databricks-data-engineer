...
# MAGIC
# MAGIC
# MAGIC DESCRIBE EXTENDED  author_counts_tmp_vw;
# MAGIC
...
# MAGIC -- Normal Query and not Streaming
...
(spark.table("author_counts_tmp_vw")                               
      .writeStream           
      .trigger(availableNow=True) #triggered incrmental batch - query will process all available data and stops when execution is completed - batch mode
      .outputMode("complete")
      .option("checkpointLocation", "dbfs:/mnt/demo/author_counts_checkpoint")
      .table("author_counts")
      .awaitTermination() #holds the process till command is completed
)
